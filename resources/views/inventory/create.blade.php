...
@section('page-title')
    {{ trans('pages/inventory.create.page_title') }}
@endsection

@section('page-content')
@include('layouts.breadcrum', ['title' => trans('pages/inventory.create.breadcrumb')])

<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
	        <div class="card">
	            {!! Form::open(['route' => ['inventory.store'], 'class' => 'form-horizontal', 'files' => true]) !!}
	                <div class="card-body">
	                    ...
	                    <div class="form-group row">
	                        ...
	                        <div class="col-sm-7">
	                            {!! Form::input('number', 'quantity', old('quantity'), ['class' => $errors->first('quantity') ? 'form-control is-invalid' : 'form-control', 'placeholder' => trans('pages/inventory.fields.quantity'), 'required' => true, 'min' => '1']) !!}
	                            @error('quantity')
	                            	<div class="invalid-feedback">{{ $message }}</div>
	                            @enderror
	                        </div>
	                    ...
	                    <div class="form-group row">
	                        ...
	                        <div class="col-sm-7">
	                        	{{ Form::textarea("observations", null, ['class' => $errors->first('observations') ? 'form-control is-invalid' : 'form-control', "placeholder" => trans('pages/inventory.fields.observations')]) }}
	                            @error('observations')
	                            	<div class="invalid-feedback">{{ $message }}</div>
	                            @enderror
	                        </div>
